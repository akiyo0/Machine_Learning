...
# print(dir + '/configuration.txt')
# print(conf.read(dir + '/configuration.txt'))
# print(conf.sections())

# patch to the datasets
path_data = conf.get('data_paths', 'path_local')
# Experiment name
name_experiment = conf.get('experiment name', 'name')
# training settings
N_epochs = int(conf.get('training settings', 'N_epochs'))
batch_size = int(conf.get('training settings', 'batch_size'))

# ============ Load the data and divided in patches
patches_imgs_train, patches_masks_train = get_data_training(
    DRIVE_train_imgs_original=path_data + conf.get('data_paths', 'train_imgs_original'),
    DRIVE_train_groudTruth=path_data + conf.get('data_paths', 'train_groundTruth'),  # masks
    patch_height=int(conf.get('data attributes', 'patch_height')),
    patch_width=int(conf.get('data attributes', 'patch_width')),
    N_subimgs=int(conf.get('training settings', 'N_subimgs')),
    inside_FOV=conf.getboolean('training settings', 'inside_FOV')
